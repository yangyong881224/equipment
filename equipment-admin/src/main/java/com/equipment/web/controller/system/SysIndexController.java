...
import com.equipment.common.utils.CookieUtils;
...
public class SysIndexController extends BaseController
{
    ...
    public String index(ModelMap mmap)
    {
        ...
        mmap.put("copyrightYear", EquipmentConfig.getCopyrightYear());
        mmap.put("demoEnabled", EquipmentConfig.isDemoEnabled());
    ...
    {
        mmap.put("version", EquipmentConfig.getVersion());
        return "main";
    }
